      ...
      <div className="container-main">
        <div className="mx-auto flex max-w-[760px] flex-col items-center gap-3 text-center">
          ...
          <p className="text-[13px] text-muted-2">
            ...
            <a href="/vibecode-this-site" className="text-primary no-underline hover:underline">How this site works</a>
            {' '}·{' '}
            <a href="https://github.com/VibeCodingApp/LetsVibeCodeit" target="_blank" rel="noopener noreferrer" className="text-primary no-underline hover:underline">Source on GitHub</a>
          </p>
