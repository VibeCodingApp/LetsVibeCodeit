...
export function Odometer({ target }: { target: number }) {
  ...
  return <span ref={ref} className="font-display text-6xl md:text-7xl font-bold text-danger tabular-nums drop-shadow-[0_0_28px_rgba(255,68,68,0.35)] motion-safe:transition-shadow">${v.toLocaleString()}</span>;
}
